...
class RealestateReceivedRequest extends FormRequest
{
/**
    ...
    */
    public function rules()
    {
        $rules =  [
            ...
            'send_house_number'=>'max:10',
            'send_house_address'=>'max:199',
            'send_realestate_price_rent'=>'max:30',
    ...
    public function messages()
    {
        return [
            ...
            'send_house_number.max'=>"Số đường Không quá :max ký tự !",
            'send_house_address.max'=>"Địa chỉ Không quá :max ký tự !",
            'send_realestate_price_ren.max'=>"Giá thuê Không quá :max ký tự !",
