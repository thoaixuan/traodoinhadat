...
<html>
<head>
    <title>Title - Bất Động Sản Bà Rịa - Vũng Tàu</title>
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"Article","name":"Title - Bất Động Sản Bà Rịa - Vũng Tàu"}</script>
    <!-- OR with multi -->
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"Article","name":"Title - Bất Động Sản Bà Rịa - Vũng Tàu"}</script>
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Title - Bất Động Sản Bà Rịa - Vũng Tàu"}</script>
</head>
<body>
