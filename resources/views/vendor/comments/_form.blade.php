        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">Nhập tên của bạn vào đây:</label>
                ...
                <div class="form-group">
                    <label for="message">Ghi địa chỉ email của bạn ở đây:</label>
            ...
            <div class="form-group">
                ...
                <div class="invalid-feedback">
                    Bình luận của bạn là bắt buộc.
                </div>
            </div>
            <button type="submit" class="btn btn-sm btn-outline-success text-uppercase">Gửi</button>
        </form>
    </div>
</div>
<br />
